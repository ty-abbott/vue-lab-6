...
<template>
  <div id="new-task-form">
    ...
    <!-- Remember to pass in the form data to the method so it can pass it to your API -->
    <!-- add .prevent to the end of the attribute's key to keep the page from reloading -->
